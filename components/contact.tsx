    ...
    >
      ...
      >
        ...
        <input
          ...
          className="px-4 my-4 transition-all rounded-lg h-14 borderBlack dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 dark:outline-none"
          required
          maxLength={100}
          autoComplete="off"
          autoCapitalize="off"
        ...
        <textarea
          className="p-4 mb-4 transition-all rounded-lg h-52 borderBlack dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 dark:outline-none"
          name="message"
          id="message"
          value={form.message}
          onChange={handleChange}
